    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="./server/requests.php" method="post">
                ...
                <textarea name="answer" class="form-control margin-bottom-15" id="answer" placeholder="Your answer..."></textarea>
        ...
        <div class="col-4">
            ...
            $categoryrRow = $categoryResult->fetch_assoc();
            echo "<h1 class='heading'>".ucfirst($categoryrRow['name'])."</h2>";
